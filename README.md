...
## Overview
This program was coded to answer a specific question for an evaluation in an academic course. It generates some numbers in tables and sorts them.
...
## Usage
1. Open 'TN2ex4.cpp' in a C++ IDE
2. Follow the program promps as needed
3. At the end, the program shows the result
